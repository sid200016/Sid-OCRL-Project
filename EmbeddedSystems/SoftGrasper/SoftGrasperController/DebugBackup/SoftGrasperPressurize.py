...
def SendPressureCommand(ser,PressureDict):
    ...
    for (k,v) in PressureDict.items():
        BArr.extend(struct.pack("f",v))
    #BArr.extend(Poverride)
    line_hold = ""
    line=ser.readline()
    print(line)
...
wait_for_ok = True
Fval={"Jaw1":0,"Jaw2":0,"Jaw3":0,"I3":10,"I1_1":0,"I1_2":0,"I1_3":0}
...
while(True):
    ...
    retval = SendPressureCommand(ser,Fval)
    print("Looping")
