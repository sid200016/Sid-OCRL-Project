...
class Wiring:
    ...
    def set_input_dim(self, input_dim):
        ...
        self.modulation_adjacency_matrix = np.zeros(
            [input_dim, self.units], dtype=np.int32
        )
    ...
    def get_config(self):
        return {
            ...
            "modulation_adjacency_matrix": self.modulation_adjacency_matrix,
    ...
    def from_config(cls, config):
        ...
        wiring.modulation_adjacency_matrix = config["modulation_adjacency_matrix"]
